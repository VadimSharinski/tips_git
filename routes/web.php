...
Route::group(['namespace' => 'User'], function (){
    ...
    Route::get('/user-signup', [UserController::class, 'signupForm'])->name('user.signupForm');
...
Route::group(['namespace' => 'Employee'], function (){
    ...
    Route::get('/employee-signup', [EmployeeController::class, 'signupForm'])->name('employee.signupForm');
    Route::post('/employee-signup', [EmployeeController::class, 'signup'])->name('employee.signup');

    Route::get('/employee-signin', [EmployeeController::class, 'signinForm'])->name('employee.signinForm');
    Route::post('/employee-signin', [EmployeeController::class, 'signin'])->name('employee.signin');
