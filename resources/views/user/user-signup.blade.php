                                    ...
                                    <div class="form-body">
                                        <form class="row g-3">
                                            <div class="col-sm-4">
                                                ...
                                                <input type="text" class="form-control" name="firstName" placeholder="Walter" value="{{old('firstName')}}">
                                            </div>
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="email" class="form-control" name="email" placeholder="example@user.com" value="{{old('email')}}">
                                            </div>
                                            <div class="col-12">
