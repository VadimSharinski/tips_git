                                    ...
                                    <div class="form-body">
                                        <form class="row g-3">
                                            <div class="col-sm-6">
                                                ...
                                                <input type="email" class="form-control" id="inputFirstName" placeholder="John">
                                            </div>
                                            <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-6">
                                                <label for="inputLastName" class="form-label">Patronymic</label>
                                                <input type="email" class="form-control" id="inputPatronymic" placeholder="Deo">
                                            </div>
                                            <div class="col-12">
